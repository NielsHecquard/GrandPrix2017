...
QT_MOC_LITERAL(5, 40, 16), // "on_debug_toggled"
QT_MOC_LITERAL(6, 57, 6) // "toggle"

    },
    "GPDriverSelector\0debugToggle\0\0car\0"
    "debug\0on_debug_toggled\0toggle"
};
...
void GPDriverSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GPDriverSelector::*_t)(int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GPDriverSelector::debugToggle)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GPDriverSelector::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GPDriverSelector.data,
      qt_meta_data_GPDriverSelector,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
