...
public:
    ...
    {
        FinnishDialog->setWindowTitle(QApplication::translate("FinnishDialog", "Dialog", 0));
        label->setText(QApplication::translate("FinnishDialog", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Rank</span></p></body></html>", 0));
        label_2->setText(QApplication::translate("FinnishDialog", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Driver</span></p></body></html>", 0));
        label_3->setText(QApplication::translate("FinnishDialog", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Hops</span></p></body></html>", 0));
        label_4->setText(QApplication::translate("FinnishDialog", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Gas</span></p></body></html>", 0));
        label_5->setText(QApplication::translate("FinnishDialog", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Boosts</span></p></body></html>", 0));
        abortButton->setText(QApplication::translate("FinnishDialog", "Ok", 0));
    } // retranslateUi
